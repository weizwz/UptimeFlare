...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: '主页',
      method: 'HEAD',
      target: 'https://weiz-home.pages.dev/',
    ...
    },
    {
      ...
      name: '博客',
      method: 'HEAD',
      target: 'https://note.weizwz.workers.dev',
    ...
    },
    {
      ...
      name: '导航',
      method: 'HEAD',
      target: 'https://weiz-nav.pages.dev/',
    ...
    },
    {
      ...
      name: 'ThisCover',
      method: 'HEAD',
      target: 'https://cover-ebon.vercel.app/',
    ...
    },
    {
      ...
      name: 'FunAnimation',
      method: 'HEAD',
      target: 'https://fun-animation.pages.dev/',
    ...
    },
    {
      ...
      name: 'Vue3-Charts',
      method: 'HEAD',
      target: 'https://vue3-charts.pages.dev/#/',
